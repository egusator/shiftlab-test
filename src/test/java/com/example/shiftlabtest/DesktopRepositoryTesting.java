...
public class DesktopRepositoryTesting {
    @Autowired
    ...
    @Autowired
    public DesktopRepositoryTesting(DesktopRepository desktopRepository) {
    ...
    @Test
    public void addDesktop_ShouldAddDesktop() {
        desktopRepository.addDesktop("askdkas",BigDecimal.TEN, 123, "Apple", (byte) 2);
    ...
    @Test
    public void getAll_shouldReturnAllDesktops () {
        Assert.assertEquals(2, desktopRepository.getAll().size());
    }
    @AfterEach
