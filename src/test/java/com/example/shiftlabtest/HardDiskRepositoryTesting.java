...
public class HardDiskRepositoryTesting {
    @Autowired
    ...
    @Autowired
    public HardDiskRepositoryTesting(HardDiskRepository hardDiskRepository) {
    ...
    public void addHardDisk_ShouldAddHardDisk() {
        hardDiskRepository.addHardDisk("askdkas",BigDecimal.TEN, 123, "Apple", 2000);
    ...
    public void getAll_shouldReturnAllHardDisk () {
        Assert.assertEquals(2, hardDiskRepository.getAll().size());
    }
    @AfterEach
