...
import com.example.shiftlabtest.repository.impl.HardDiskRepository;
import com.example.shiftlabtest.repository.impl.MonitorRepository;
...
public class MonitorRepositoryTesting {
    ...
    @Autowired
    public MonitorRepositoryTesting(MonitorRepository monitorRepository) {
    ...
    @Test
    public void addHardDisk_ShouldAddHardDisk() {
        monitorRepository.addMonitor("askdkas",BigDecimal.TEN, 123, "Apple", 123);
    ...
    @Test
    public void getAll_shouldReturnAllHardDisk () {
        Assert.assertEquals(2, monitorRepository.getAll().size());
    }
    @AfterEach
